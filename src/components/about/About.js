...
const About = () => {
  ...
  <h2 className="text-primary fw-bold text-center" style={{paddingBottom:"30px"}}>Company Overview</h2>
    ...
    <div className="col-md-8">
      <div className="p-4 bg-light rounded shadow-sm animate__animated animate__fadeInRight">
        <p className="text-muted-1">
          Kota Management Services Private Limited (KMS) is a powerhouse in
          management consultancy, driven by a mission to transform businesses
          with innovative, results-oriented solutions. We specialize in
          delivering strategic, operational, and organizational excellence,
          empowering ventures to navigate complexities and seize opportunities
        ...
        <p>Director</p>
          ...
          <section style={{background:"lightgray",padding:"50px,0px"}}>
            <div className="container my-5" style={{padding:"50px,0px"}}>
              <div className="row align-items-center" style={{padding:"50px,0px"}}>
                {/* Mission Section */}
                <motion.div
                  className="col-md-6"
              ...
              <div className="row align-items-center mt-5" style={{padding:"50px,0px"}}>
                {/* Vision Section */}
                <motion.div
                ...
                >
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    transforming businesses and enabling success in a
